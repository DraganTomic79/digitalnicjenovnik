...
class MenuApp {
  ...
  createImageWithFallback(item) {
    ...
    return `<div class="item-image-wrapper"><img id="${imageId}" src="${item.slikaURL}" alt="${altText}" class="item-image clickable-image" style="cursor: pointer;" /><div class="item-placeholder" style="display: none;"><i class="fas fa-image"></i></div><span class="image-zoom-hint"><i class="fas fa-expand"></i></span></div>`;
  }
